...
public class UserServiceImpl implements UserService {
    ...
    public void initializeDB() {
        ...
        User first = new User("1", "11", (byte) 11, "1",
                "1", Set.of(adminRole));
        User user = new User("mtvvrm1", "mtvvrm11", (byte) 22,
                "mtvvrm@gmail.ru", "1", Set.of(adminRole));
        User admin = new User("mtvvrm2", "mtvvrm22", (byte) 111,
                "ouaaey@gmail.ru", "1", Set.of(userRole));
        User second = new User("2", "22", (byte) 22,
                "2", "2", Set.of(userRole));
